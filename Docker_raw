# ffmpeg-quality - http://ffmpeg.org/download.html
#
# https://hub.docker.com/r/zsiec/ffmpeg-quality/
#
#
...
RUN \
	DIR=/tmp/vmaf && \
        git clone --branch ${LIBVMAF_VERSION} --depth 1 https://github.com/Netflix/vmaf.git ${DIR} ; \
        cd ${DIR}/ptools ; \
        make; \
        cd ${DIR}/wrapper ; \
        make; \
...
RUN  \
        ...
        curl -sLO https://ffmpeg.org/releases/ffmpeg-snapshot-git.tar.bz2 && \
        tar -jx --strip-components=1 -f ffmpeg-snapshot-git.tar.bz2
...
MAINTAINER  Thomas Symborski <thomas.symborski@gmail.com>
